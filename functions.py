...
"""
Download cadaster data for specified geographic areas.
...
Parameters:
    ...
    force: If True, remove existing directory before downloading.

Returns:
    None. Creates downloaded files in the working directory.
"""
...
def download(wd, province_codes=None, ine_codes=None, cadaster_codes=None,
    ...
    """
    Force parameter: If True, remove existing directory before downloading.
    """
    if force:
        try:
            os.removedirs(wd)
