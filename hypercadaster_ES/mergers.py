...
"""
Utility functions for merging geospatial data with cadaster information
"""
...
def make_valid(gdf):
    ...
    Returns:
    GeoDataFrame: Input data with validated geometries
    """
...
def get_cadaster_address(cadaster_dir, cadaster_codes, directions_from_CAT_files=True, CAT_files_dir="CAT_files",
    ...
    """
    Extract and process cadaster address information from multiple sources

    Parameters:
    cadaster_dir (str): Directory containing cadaster data
    cadaster_codes (list): List of cadaster codes to process
    directions_from_CAT_files (bool): Whether to include data from CAT files
    CAT_files_dir (str): Directory containing CAT files
    directions_from_open_data (bool): Whether to include open data sources
    open_data_layers_dir (str): Directory containing open data layers

    Returns:
    GeoDataFrame: Processed address data with spatial information
    """
