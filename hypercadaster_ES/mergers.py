...
"""
Make geometry valid for a GeoDataFrame
"""
def make_valid(gdf):
...
"""
Get cadaster addresses for multiple municipalities

Parameters:
    cadaster_dir (str): Directory containing cadaster data
    cadaster_codes (list): List of cadaster codes
    directions_from_CAT_files (bool): Whether to include directions from CAT files
    CAT_files_dir (str): Directory containing CAT files
    directions_from_open_data (bool): Whether to include directions from open data
    open_data_layers_dir (str): Directory containing open data layers

Returns:
    gdf (GeoDataFrame): GeoDataFrame with cadaster addresses
"""
...
"""
Join cadaster buildings data with other datasets
...
Returns:
    gdf (GeoDataFrame): GeoDataFrame with building data
"""
...
"""
Join cadaster zones with other data
...
Returns:
    gdf (GeoDataFrame): GeoDataFrame with zone information
"""
...
"""
Join cadaster parcels with other data
...
Returns:
    gdf_joined (GeoDataFrame): GeoDataFrame with parcel information
    parcel_gdf (GeoDataFrame): GeoDataFrame with parcel geometries
"""
...
"""
Join administrative divisions naming with other data
...
Returns:
    gdf (GeoDataFrame): GeoDataFrame with administrative divisions information
"""
...
"""
Join all cadaster data together
...
Returns:
    gdf (GeoDataFrame): Final GeoDataFrame with all joined data
"""
...
"""
Join Digital Elevation Model (DEM) raster data with other data

Parameters:
    gdf (GeoDataFrame): Input GeoDataFrame
    raster_dir (str): Directory containing raster data
...
"""
Join census tract data with other data

Parameters:
    gdf (GeoDataFrame): Input GeoDataFrame
    census_tract_dir (str): Directory containing census tract data
    columns (dict): Columns mapping (default: CUSEC -> section_code, CUDIS -> district_code, geometry -> census_geometry)
    geometry_column (str): Name of the geometry column (default: 'census_geometry')
    year (int): Census year (default: 2022)

Returns:
    census_gdf (GeoDataFrame): GeoDataFrame with census tract data
"""
...
"""
Join neighborhood data with other data

Parameters:
    gdf (GeoDataFrame): Input GeoDataFrame
    neighbourhoods_dir (str): Directory containing neighborhood data
    columns (dict): Columns mapping (default: codi_barri -> neighborhood_code, nom_barri -> neighborhood_name, nom_districte -> district_name, geometria_etrs89 -> neighborhood_geometry)
    geometry_column (str): Name of the geometry column (default: 'neighborhood_geometry')

Returns:
    neighbourhoods_gdf (GeoDataFrame): GeoDataFrame with neighborhood data
"""
...
"""
Join postal code data with other data

Parameters:
    gdf (GeoDataFrame): Input GeoDataFrame
    postal_codes_dir (str): Directory containing postal code data
    columns (dict): Columns mapping (default: CODPOS -> postal_code, geometry -> postal_code_geometry)
    geometry_column (str): Name of the geometry column (default: 'postal_code_geometry')

Returns:
    postal_codes_gdf (GeoDataFrame): GeoDataFrame with postal code data
"""
